...
export class ProductListComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  products$:Observable<Product[]> | undefined;  //La varaibile che ospita l'Observable si indica con il $ a fine nome
  ...
  constructor(private productsService: ProdcutsService) {}  //CHiamo il servizio ProductService
